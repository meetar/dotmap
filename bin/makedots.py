...
if __name__=='__main__':
	...
	for state in states:
		...
		if not os.system("[ -e /data/zips/ tabblock2010_"+state+"_pophu.zip]"):
			os.system("wget \"ftp://ftp2.census.gov/geo/tiger/TIGER2010BLKPOPHU/tabblock2010_"+state+"_pophu.zip")
		else:
			print("tabblock2010_%s_pophu.zip already exists"%state)
		zf = zipfile.ZipFile("../data/tabblock2010_"+state+"_pophu.zip")

		print "unzipping: %s"%zf
